    ...
    return (
        <footer className="font-['Inter'] py-[6rem]">
            <div className="w-[70%] mx-auto text-center flex flex-col">
                <p className="text-indigo-700 text-5xl font-bold leading-[72px]">{language === "ENG" ? footer.sendMeMsg.ENG : footer.sendMeMsg.TR}</p>
                <div className="flex flex-col justify-center items-center gap-5">
                    <p className="text-slate-900 text-2xl font-normal leading-9">{language === "ENG" ? footer.message.ENG : footer.message.TR}</p>
