...
- [X] `npm create vite@latest FSWeb-Frontend-Final-Project` komutuyla boş bir çalışma başlatabilirsin.
- [X] Oluşturulan `FSWeb-Frontend-Final-Project` klasörüne gir.
